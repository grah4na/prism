 ...
 * under the License.
 *
 * Modified by Ben Kallus for the HTTP Prism.
 */
...
class PrismServerHandler extends SimpleChannelInboundHandler <Object> {
...
class PrismServerInitializer extends ChannelInitializer < SocketChannel > {
    ...
    public void initChannel(SocketChannel ch) {
        ...
        p.addLast(new PrismServerHandler());
    }
}

public final class PrismServer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            b.group(bossGroup, workerGroup)
                ...
                .childHandler(new PrismServerInitializer());
